...
exp(ikφ) is a fiberwise Koopman eigenfunction. Symplecticity removes the arbitrary
nonlinear invariant gauge: the circle area I is checked against ∮p dq / 2π.</p>
<h2>Boundary</h2>
<p>This certificate covers autonomous, conservative, periodic one-degree-of-freedom
data inside the observed action range. It does not yet cover separatrix charts,
